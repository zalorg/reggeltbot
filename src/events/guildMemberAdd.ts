        ...
        ref
          ...
          .set({
            ...
            permissions: {
              ...
              MANAGE_CHANNELS: member.permissions.has("MANAGE_CHANNELS"),
              MANAGE_GUILD: member.permissions.has("MANAGE_GUILD"),
              MANAGE_MESSAGES: member.permissions.has("MANAGE_MESSAGES"),
            },
